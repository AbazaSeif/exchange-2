...
<div class="right">
    ...
    <div id="tabs">
        ...
        $this->widget('zii.widgets.CListView', array(
            ...
            'sorterHeader'=>'',
            'itemsTagName'=>'ul',
            'sortableAttributes'=>array('t_id', 'date_close', 'location_from', 'location_to', 'num_rates'=>'Кол-во ставок', 'num_users'=>'Кол-во участников', 'win' => 'Фирма-победитель', 'price'=>'Лучшая ставка'),
            'pager'=>array(
                'class'=>'CLinkPager',
                'header'=>false,
                'prevPageLabel'=>'<',
