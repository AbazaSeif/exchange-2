...
<div id="faq-wrapper">
    <ol class="faq-main">
        ...
        <li><span class="label">Как активировать/блокировать пользователя</span>
            <div class="paragraph">
                <div>Открыть "Перевозчики->Компании" или "Перевозчики->Контактные лица", найти нужного перевозчика (можно поиском), изменить поле "Статус", нажать кнопку "Сохранить".</div>
        ...
        <li><span class="label">Пользователь забыл пароль. Как поменять пароль</span>
            <div class="paragraph">
                <div>Прежде, чем предлагать пользователю указанные ниже способы убедитесь, что он не имеет статус "Блокирован", "Временно блокирован" или "Не подтвержден".</div>
