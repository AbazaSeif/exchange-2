                                                                        ...
                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0" >
                                                                            ...
                                                                            <tr>
                                                                                <td style="color:#a1a1a1; font-family:Verdana; font-size:12px; line-height:18px; text-align:left; font-weight:normal">
                                                                                    Ваша учетная запись была активирована на бирже перевозок "ЛБР-Агромаркет".
                                                                                    <br /><br />
                                                                                    <a href="http://exchange.lbr.test/" class="link-u" style="color:#2b9208; text-decoration:underline" target="_blank"><span class="link-u" style="color:#008672; text-decoration:underline">Перейти на биржу</span></a>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                    </td>
