...
class SiteController extends Controller
{
    ...
    */
    ...
    public function actionDelContactUserWithDublicateEmail()
    {
        $emails = array();
        ...
        foreach($duplicateData as $dublicateEmail) {
            $users = Yii::app()->db->createCommand()
                ->select('id')
                ->from('user')
                ->where('type_contact = 1 and email like "'.$dublicateEmail['email'].'"')
                ->queryAll()
            ;
            foreach($users as $user){
                ...
                $email->from_email = Yii::app()->params['adminEmail'];
                $email->from_name  = 'Биржа перевозок ЛБР АгроМаркет';
                $email->to_email   = $dublicateEmail['email'];
                $email->to_name    = '';
                $email->subject    = 'Извещение';
                $email->type = 'text/html';
                $email->body = '<!-- Content -->
                        <tr>
                            <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td class="text" style="margin: 0; color:#a1a1a1; font-family:Verdana; font-size:12px; line-height:18px; text-align:left" valign="top">
                                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0" >
                                                                                    <tr>
                                                                                        <td style="color:#666666; font-family:Verdana; font-size:20px; line-height:24px; text-align:left; font-weight:normal">
                                                                                            Дублирование почтовых ящиков (Email-ов)
                                                                                        </td>
                                                                                        <tr>
                                                                                            <td>
                                                                                                <img src="http://exchange.lbr.ru/images/test/empty.gif" width="1" height="10" style="height:10px; float: left" alt="" />
                                                                                        ...
                                                                                        <tr>
                                                                                            <td style="width: 100%; padding-top: 10px; padding-bottom: 10px; color:#666666; font-family:Verdana; font-size:12px; line-height:18px; text-align:left; font-weight:normal">
                                                                                                Почтовые ящики контакного лица и основного пользователя должны быть различными.
                                                                                            </td>
                                                                                        </tr>
                                                                                    <tr>
                                                                                        <td>
                                                        ...
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                            <tr>
                                                                <td class="text" style="color:#000000; font-family:Verdana; font-size:14px; line-height:18px; text-align:left; padding-top: 10px; padding-bottom: 5px" valign="top">
                                                                    Ваш основной пользователь и контактное лицо имеют одинаковые Email, в связи с этим контактное лицо было удалено.
                                                                    <br/><br/>
                                                                    Для создания нового контактного лица следует в меню "Настройки" основного пользователя выбрать раздел "Контактные лица", кнопка "Создать". 
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
