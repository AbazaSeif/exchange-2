                                                            ...
                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0" >
                                                                <tr>
                                                                    ...
                                                                    <td class="text" style="margin: 0; color:#a1a1a1; font-family:Verdana; font-size:12px; line-height:18px; text-align:left" valign="top">
                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0" >
                                                                            <tr>
                                                                                <td style="padding-bottom: 10px; color:#000000; font-family:Verdana; font-size:14px; line-height:18px; text-align:left; font-weight:normal">
                                                                                    Запрос на восстановление пароля.
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td style="color:#000000; font-family:Verdana; font-size:14px; line-height:18px; text-align:left; font-weight:normal">
                                                                                    Пользователь "ЧП Уткин В.Ю." запросил восстановление пароля, однако в базе не значится его email адрес. 
                                                                                    <br/><br/>
                                                                                    Просьба связаться с ним, узнать и внести в 1С либо на биржу email, и попросить его еще раз восстановить пароль. 
                                                                                </td>
                                                                            </tr>
