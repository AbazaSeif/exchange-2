...
$.tzPOST = function(action,data,callback){
	//$.post('php/ajax.php?action='+action,data,callback,'json');
        $.post('http://exchange/protected/extensions/chat/ajax.php?action='+action, data, callback, 'json');
...
$.tzGET = function(action,data,callback){
	//$.get('php/ajax.php?action='+action,data,callback,'json');
        ...
        $.get('http://exchange/protected/extensions/chat/ajax.php?action='+action,data,callback,'json');
}
